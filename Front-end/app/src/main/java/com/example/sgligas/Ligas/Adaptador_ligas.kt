...
class Adaptador_ligas(
    ...
    class LigaViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val linearLayoutNombreLiga: LinearLayout = itemView.findViewById(R.id.LinearLayout_NombreLiga)
        ...
        val btnMostrarCategorias: ImageButton = itemView.findViewById(R.id.imageButton_mostrar_categorias)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LigaViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.item_liga, parent, false)
    ...
    override fun onBindViewHolder(holder: LigaViewHolder, position: Int) {
        ...
        for (element in jsonArray) {
            ...
            // Aquí puedes crear instancias de la clase Categoria o realizar otras operaciones necesarias
            val categoria = Categoria(idCategoria, nombreCategoria, numEquipos)

            // Agregar la instancia a tu lista de categorías
...
// Crear y configurar tu adaptador de categorías
        val adapter = Adaptador_categorias_liga(
            ...
            object : Adaptador_categorias_liga.OnItemClickListener {
                override fun onItemClick(categoria: Categoria) {
                    // Implementa lo que desees hacer al hacer clic en una categoría
