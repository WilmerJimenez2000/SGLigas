    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val listaDeTorneosJugador = listOf(
            EstadisticaJugador(
                ...
                amarillas.toInt(),
                goles.toInt(),
                golesRecibidos.toInt(),
                autogoles.toInt(),
                posicion,
                foto,
                numeroCamiseta.toInt()
            ),
            )
        val adapter = Adaptador_torneos_estadisticas(
            listaDeTorneosJugador,
            object : Adaptador_torneos_estadisticas.OnItemClickListener {
                override fun onItemClick(estadisticaJugador: EstadisticaJugador) {
                    // Se maneja la acción al precionar estadísticas jugador
                }
            })
