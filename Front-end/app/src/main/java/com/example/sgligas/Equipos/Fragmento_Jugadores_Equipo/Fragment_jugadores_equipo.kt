...
class Fragment_jugadores_equipo : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val recyclerViewMain: RecyclerView =
            view.findViewById(R.id.recycler_main_jugadores_posicion)
        // Se crea una lista de Tarjeta_posicion_jugador que contiene todos los meses y partidos
        val listajugadoresEstadisticasEquipo =
            File(requireContext().filesDir, "cache_JEstadisticasEquipo.txt").readText()
        ...
        try {
            ...
            Log.e(
                "fragmento",
                "Error al parsear el JSON de jugadoresEstadisticas: $listajugadoresEstadisticasEquipo"
            )
        }
    }
}