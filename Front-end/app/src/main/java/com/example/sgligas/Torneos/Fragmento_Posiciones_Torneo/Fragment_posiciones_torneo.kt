        ...
        try {
            ...
            if (json.has("tabla")) {
                ...
                for (equipo in datosArray) {
                    ...
                    val objetoEquipo =
                        EquipoPosiciones(nombre, escudo, pg, pe, gf, gc, puntos, gol_diferencia)
                    tablaPosiciones.add(objetoEquipo)
                }
                // Se crea y establece el adaptador después de analizar exitosamente el JSON
                val adaptador = AdaptadorPosiciones(
                    tablaPosiciones,
                    object : AdaptadorPosiciones.OnItemClickListener {
